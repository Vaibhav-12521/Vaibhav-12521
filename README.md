...
I'm a **Full-Stack Web Developer** who ships real, production products — not throwaway demos.

🚀 **What I'm building now:** **[Medstocksy](https://medstocksy.in)** — a live pharmacy inventory & POS SaaS in **React + TypeScript** on **Supabase (PostgreSQL)**, with Google OAuth, row-level security, and a relational schema for products, batches, customers, and billing.

🤖 **On the AI side:** I integrate **LLMs (Groq · LLaMA 3.1)** directly into product flows — including **EVA**, a Flask chatbot with session memory and streaming responses.

🏆 **Recognition:** Runner-up at **Hack-It-Out, Technex 2025 (IIT BHU)** and selected for the **Google GenAI Exchange Program** (prompt engineering, RAG, Vertex AI).
...
| **[EVA](https://github.com/Vaibhav-12521/EVA)** — AI Chatbot with LLM integration | Python · Flask · Groq · LLaMA 3.1 · REST | ✅ Shipped |
...
<a href="https://github.com/ryo-ma/github-profile-trophy">
  <img src="https://github-profile-trophy.vercel.app/?username=Vaibhav-12521&theme=tokyonight&no-frame=true&column=7" alt="Trophies"/>
</a>
